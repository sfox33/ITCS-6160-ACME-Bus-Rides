<?php
	...
	if($tripId == -1) {
		header('Location:' . $app_path . 'view/join.php?error=badId');
		exit;
	} else if(!isset($_COOKIE['Id'])) {
		header('Location:' . $app_path . 'view/join.php?error=noCookie');
		exit;
	} else {
		...
		$sql = "INSERT INTO userpertrip (userId, tripId) VALUES(:uId,:tId)";
		...
		/*header('Location:' . $app_path . 'view/join.php');
		exit;*/
	}
?>